...
# Created by write_sdc on Fri Oct 17 02:54:20 2025
...
create_generated_clock [get_pins UART_RX_ClkDiv/o_div_clk]  -name UART_RX_CLK  -source [get_ports UART_CLK]  -master_clock UART_CLK  -divide_by 1  -add
set_clock_uncertainty -setup 0.2  [get_clocks UART_RX_CLK]
set_clock_uncertainty -hold 0.1  [get_clocks UART_RX_CLK]
create_generated_clock [get_pins UART_TX_ClkDiv/o_div_clk]  -name UART_TX_CLK  -source [get_ports UART_CLK]  -master_clock UART_CLK  -divide_by 32  -add
...
set_input_delay -clock UART_RX_CLK  54.2592  [get_ports UART_RX_IN]
...
set_output_delay -clock UART_RX_CLK  54.2592  [get_ports parity_error]
set_output_delay -clock UART_RX_CLK  54.2592  [get_ports framing_error]
set_clock_groups -asynchronous -name UART_CLK_1 -group [list [get_clocks UART_CLK] [get_clocks UART_RX_CLK] [get_clocks UART_TX_CLK]] -group [list [get_clocks REF_CLK] [get_clocks ALU_CLK]] -group [get_clocks DFTCLK]
