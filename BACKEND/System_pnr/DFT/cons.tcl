...
set_dont_touch_network [get_clocks $DFT_CLK_NAME]
...
set DFT_delay [expr 0.2*$DFT_CLK_PER]

#Inputs
set_input_delay  $RX_delay  -clock $G_CLK1_NAME [get_port UART_RX_IN]

#Constrain Scan Input Paths
set_input_delay $DFT_delay  -clock $DFT_CLK_NAME [get_port test_mode]
set_input_delay $DFT_delay  -clock $DFT_CLK_NAME [get_port SI]
set_input_delay $DFT_delay  -clock $DFT_CLK_NAME [get_port SE]
...
set_output_delay $DFT_delay -clock $DFT_CLK_NAME [get_port SO]
