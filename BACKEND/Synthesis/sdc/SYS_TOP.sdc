...
# Created by write_sdc on Wed Oct 1 08:43:30 2025
...
set_clock_groups -asynchronous -name UART_CLK_1 -group [list [get_clocks UART_CLK] [get_clocks UART_RX_CLK] [get_clocks UART_TX_CLK]] -group [list [get_clocks REF_CLK] [get_clocks ALU_CLK]]
